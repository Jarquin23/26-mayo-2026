...
- Crea la clase de la acción en el paquete `com.tuempresa.Facturar.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.tuempresa.Facturar.acciones.MostrarImporte"/>
</controlador>
```
...
- ✅ Coloca las clases de acción en `com.tuempresa.Facturar.acciones`
...
```java
package com.tuempresa.Facturar.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `com.tuempresa.Facturar.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
